...
import Banner from '../assets/newUI/banner.png'
...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    //primary colors
    primary1: darkMode ? '#2F75EE' : '#2F75EE',
    primary2: darkMode ? '#0097fb' : '#FF8CC3',
    primary3: darkMode ? '#2F75EE' : '#2F75EE',
    primary4: darkMode ? '#376bad70' : '#F6DDE8',
    primary5: darkMode ? '#153d6f70' : '#ebebeb',

    // color text
    primaryText1: darkMode ? '#2F75EE' : '#2F75EE',
...
body {
  ...
  background-image: ${({ theme }) =>
    `radial-gradient(50% 50% at 50% 50%, ${transparentize(0.8, '#fff')} 0%, ${transparentize(1, '#db4690')} 100%)`};
